...
class SyphtClient:
    ...
    def _get_annotations(
        ...
        """Fetches a single page of annotations skipping the given offset number of annotations first.  Use get_annotations to fetch all pages."""
    ...
    def _get_annotations_for_docs(self, doc_ids, endpoint=None, offset=0):
        """Fetches a single page of annotations skipping the given offset number of annotations first.  Use get_annotations_for_docs to fetch all pages."""
